...
/**
 * {@linkplain SessionExpirationServiceInitializer_SessionMetadata_Get} initializes and starts
 ...
 *
 */
public class SessionExpirationServiceInitializer_SessionMetadata_Get implements LifecycleListener {
	...
	public void stateChanged(LifecycleEvent event) {
		...
		case STARTED:
			...
			SessionExpirationService_SessionMetadata_Get.getExpirationService().initialize(serviceProperties);
			break;
